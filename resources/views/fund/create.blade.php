...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <form class="form-horizontal" action="/admin/fund" method="post">
                    @csrf
                    <div class="card-body">
                        <h4 class="card-title">Add New Fund Performance Value</h4>
                        ...
                        <div class="form-group row">
                            <label for="oln" class="col-sm-3 text-right control-label col-form-label">Other Language
                                Name</label>
                            <div class="col-sm-9">
                                <input type="text" required class="form-control" id="oln" placeholder="Name"
