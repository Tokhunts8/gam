...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <form class="form-horizontal" action="/admin/about" method="post">
                    @csrf
                    <div class="card-body">
                        <h4 class="card-title">Add New Experience Or Education</h4>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control datepicker-autoclose" id="From"
                                       placeholder="dd/mm/yyyy" value="{{old('from')}}"
                                       name="from" required>
                                @error('from')
                                <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control datepicker-autoclose" id="To"
                                       placeholder="dd/mm/yyyy" value="{{old('to')}}"
                                       name="to">
                                @error('to')
                                <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <select class="select2 form-control custom-select" id="Type" name="type" required>
                                    <option @if(1 === old('type')) selected @endif value="1">Աշխատանք
                                    </option>
                                    <option @if(2 === old('type')) selected @endif value="2">Ուսում
                                    </option>
                                </select>
                                @error('type')
                                <div class="alert alert-danger">{{ $message }}</div>
